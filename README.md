...
| Unicode                  | A standardized encoding system that represents text and symbols in computers and other devices. It includes a vast range of characters, including letters, digits, punctuation marks, and special symbols from many different scripts and languages.                                                                                |
...
| ASCII                    | A standardized encoding system that represents text and symbols in computers and other devices. It includes a limited range of characters, including the English
| UTF-8                    | A widely used encoding system for Unicode characters. It encodes each Unicode character as a sequence of one to four 8-bit bytes, allowing for efficient representation of characters from a wide range of scripts and languages. UTF-8 is particularly well-suited for use on the internet, as it is able to represent all valid Unicode code points and is compatible with ASCII. |                                                      

...
|-Lexer<br>-token<br>-Lexical Analysis  | <ul><li><b>Lexer</b> : A lexer (also known as a lexical analyzer or tokenizer) is a program that takes input in the form of a sequence of characters and divides it into a series of tokens. It is usually the first step in the process of compiling or interpreting a program. </li><li><b>Token</b> : A token is a unit of information that the lexer recognizes in the input. It can be a keyword, a punctuation character, a data type, or any other kind of syntactic element that is meaningful to the programming language. The lexer is responsible for identifying the individual tokens in the input and passing them on to the next phase of the compiler or interpreter.</li><li><b>Lexical analysis</b> : Lexical analysis is the process of dividing the input into tokens. It is usually performed by a lexer or tokenizer as the first step in the process of compiling or interpreting a program.</li> </ul>|
